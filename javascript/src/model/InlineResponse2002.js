...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WishListApi.InlineResponse2002 = factory(root.WishListApi.ApiClient, root.WishListApi.WishListItem);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [WishListItem]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/WishListItem>} data
   */
